...
app.use(cors({
  ...
  credentials: true,
  // Lets the frontend read the server-computed waybill filename off the
  // download response (see routes/shipments.js generate-waybill /
  // waybills/bulk-download) instead of guessing/hardcoding one client-side.
